package com.xpy.administrator.probityeducation.view;
 ...
 * 直接引用的别人的自定义View
 * @author chenlin
 * 网址：http://blog.csdn.net/lovoo/article/details/51629171
 */
public class MyScaleView extends ImageView implements ViewTreeObserver.OnGlobalLayoutListener,ScaleGestureDetector.OnScaleGestureListener,View.OnTouchListener{
    /** 表示是否只有一次加载 */
    ...
    public MyScaleView(Context context, AttributeSet attrs, int defStyle) {
